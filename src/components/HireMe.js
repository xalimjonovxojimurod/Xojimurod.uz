...
import { CircularText } from './Icons'; // To'g'ri yo'lni tekshiring
  ...
  return (
    ...
    flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute sm:right-0'>
      <div className='w-48 h-auto flex items-center justify-center relative md:w-24'>
        ...
        <Link href="https://t.me/The_Manager712" className='flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark
        ...
        '>Hire Me</Link>
        {/* Bu yerda boshqa kontent qo'shishingiz mumkin */}
      </div>
    </div>
  )
}
