...
// The Skill component takes name, x, and y as props to position and animate each skill.
...
const Skills = () => {
  return (
    <>
      ...
      {/* Container for the skills and the main central "Web" bubble */}
      <div
        className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark
       lg:h-[80vh] sm:h-[60vh] xs:h-[50vh]
       lg:bg-circularLightLg lg:dark:bg-circularDarkLg
       md:bg-circularLightMd md:dark:bg-circularDarkMm
       ...
       '>
        ...
        {/* Skill bubbles with dynamic positions using the Skill component */}
        <Skill name="HTML" x="-20vw" y="2vw" />
        <Skill name="CSS" x="-5vw" y="-10vw" />
        <Skill name="JavaScript" x="20vw" y="6vw" />
        <Skill name="Next.js" x="0vw" y="12vw" />
        <Skill name="React.js" x="-25vw" y="-15vw" />
