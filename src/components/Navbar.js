...
const CustomLink = ({ href, title, className = "" }) => {
    const router = useRouter(); // useRouter'ni chaqirish
...
const Navbar = () => {
    ...
    return (
        <header className="w-full px-32 py-8 font-medium flex items-center justify-between
         dark:text-light relative z-10 lg:px-16 md:px-21 sm:px-8
        "> 
      ...
      <span className={`bg-dark dark:bg-light block transition-all duration-300 ease-out h-0.5 w-6 rounded-sm translate-y-0.5 ${isOpen ? '-rotate-45 -translate-y-1' : 'translate-y-0.5'}`}></span>
           ...
           <nav>
            ...
            <nav className='flex items-center justify-center flex-wrap'>
                ...
                <motion.a href="https://pinterest.com" target={"_blank"} className="w-6 mx-3 bg-dark rounded-full dark:bg-light"
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
           ...
           <nav className='flex items-center flex-col justify-center'>
            ...
            <nav className='flex items-center justify-center flex-wrap mt-2'>
                ...
                <motion.a href="https://pinterest.com" target={"_blank"} className="w-6 mx-3 bg-dark rounded-full dark:bg-light sm:mx-1"
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}
