...
import profilePic from '../../public/images/profile/xojimurod.1.jpg.png'
    ...
    <>
      ...
      <main className="flex w-full flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          <AnimatedText text="Passion Fuels Purpose!" className="mb-16 lg:text-7xl sm:!text-6xl xs:!test-4xl sm:mb-8" />
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            <div className="col-span-3 relative h-max rounded-xl border-2 border-solid border-dark bg-light p-8 dark:bg-dark dark:border-light xl:col-span-4 md:order-1  md:col-span-8">
              <div className=' absolute  top-0  -right-3  -z-10  w-[102%]  h-[103%]  rounded-[2rem]  bg-dark dark:bg-light ' />
              <Image src={profilePic} alt="Xojimurod" className="w-full h-auto rounded-xl" 
               priority
            ...
            <div className='col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3'>
               <div className='flex flex-col items-end justify-center xl:items-center'>
                 <span className='inline-block text-7xl font-bold md:text-6xl m:text-5xl xs:text-4xl'> 
