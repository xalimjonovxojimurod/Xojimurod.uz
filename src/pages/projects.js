    ...
    return (
      <article className='w-full flex items-center justify-between relative  rounded-br-2xl
        ...
        <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
          ...
          <Link href={link} target="_blank" 
            className='hover:underline underline-offset-2' aria-label={`Visit ${title}`}>
            <h2 className='my-2 w-full text-left text-3xl md:text-4xl font-bold dark:text-light sm:text-sm'>{title}</h2>
          </Link>
          
          <p className='my-1 font-medium text-dark dark:text-light sm:text-sm'>{summary}</p>
          
          <div className='flex items-center mt-4 space-x-4'>
            <Link href={github} target="_blank" aria-label={`GitHub repository for ${title}`}>
              <GithubIcon className='w-6 h-6' />
            </Link>
            
            <Link href={link} target="_blank" className='text-primary dark:text-primaryDark font-semibold hover:underline sm:px-4 sm:text-base'>
              Visit Project
            </Link>
          </div>
        </div>
         ...
         <main className='w-full mb-16 flex flex-col items-center justify-center dark:text-light'>
            <Layout className='pt-16'>
                ...
                <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
                    ...
                    <div className='col-span-6 sm:col-span-12'>  {/* Project qo'shish  col-span-6 */}
...
export default projects  //4:06:45 npm run dev
